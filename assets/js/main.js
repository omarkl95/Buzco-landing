    ...
    $('.instafeed').each(function(){
        var $this = $(this),
            ...
            $feed = new Instafeed({
                ...
                limit: 6,
                template: '<li><a href="{{link}}" target="_new"><img src="{{image}}" /><span class="hover"><span><i class="fa fa-heart"></i>{{likes}}</span><span><i class="fa fa-comments"></i>{{comments}}</span></span></a></li>',
            });
        $feed.run();
    });
}
